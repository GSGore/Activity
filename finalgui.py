#Interface Designing
from tkinter import *      # to Construct Graphical User Interface
from tkinter import simpledialog  # Button

from sklearn.model_selection import train_test_split      #implement machine learning model
...
def Weight_Loss():
    ...
    USER_INP = simpledialog.askstring(title="Food Timing", prompt="Enter 1 for Breakfast, 2 for Lunch, 3 for Dinner and 4 for activity")
...
def Weight_Gain():
    ...
    for ii in range(len(y_pred)):
        try:
            if y_pred[ii-1]==1 or y_pred[ii-1]==2:
                print (Food_itemsdata[ii])
        except:
            pass
